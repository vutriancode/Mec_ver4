...
d=pd.read_csv("Fuzzy_5phut.csv")[0:100]

a=pd.read_csv("FDQO_5phut.csv")[0:100]

b=pd.read_csv("DQL_5phut.csv")[0:100]
c1=pd.read_csv("n_quality_tasks_mab.csv")[0:100]
d1=pd.read_csv("n_quality_tasks_fuzzy.csv")[0:100]

a1=pd.read_csv("n_quality_tasks_fdqo.csv")[0:100]

b1=pd.read_csv("n_quality_tasks_dql.csv")[0:100]
