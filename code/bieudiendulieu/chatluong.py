...
def column_chart1(strs):
    ...
    fig, ax = plt.subplots()
    files=pd.read_csv("n_quality_tasks_fuzzy.csv")[0:100]
    ...
    #plt.show()
    plt.grid(alpha=0.5)
    plt.savefig("Fuzzyqualitywithtimeslots.eps")
def pie_chart1(strs):
    x=[i for i in range(1,101)]
    labels=["Combine fuzzy and deep q 1","deep q learning 1","fuzzy","random"]
    fig, ax = plt.subplots()
    files=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/15092020/code/result4/deep q learning 1/chatluong.csv")[0:100]
    for i in range(2,6):
        files1=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/15092020/code/result4/deep q learning "+str(i)+"/chatluong.csv")[0:100]
