...
c=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/15092020/code/result4/fuzzy/chiatask.csv")[0:124924]
d=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/15092020/code/result4/random/chiatask.csv")[0:124924]

a=[]
b=[]
bins=[i*0.1 for i in range(0,21)]
for i in range(1,6):
    files3=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/15092020/code/result4/Combine fuzzy and deep q "+str(i)+"/chiatask.csv")[0:124924]
    a=np.concatenate((a,files3["reward"].to_numpy()), axis=0)
    files4=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/15092020/code/result4/deep q learning "+str(i)+"/chiatask.csv")[0:124924]
